# Spigen(슈피겐) - 프리미엄 쇼핑몰 프로젝트

## 프로젝트 개요

### 프로젝트 주제
**프리미엄 케이스 쇼핑몰 웹사이트** - 사용자 친화적인 인터페이스와 완전한 반응형 디자인을 갖춘 주변기기 플랫폼

### 제작 목적
- **실전 웹 개발 학습**: HTML, CSS(SCSS), JavaScript를 활용한 실제 쇼핑몰 구현
- **반응형 웹 디자인 마스터**: 모바일, 태블릿, 데스크톱 모든 기기에서 동일한 사용자 경험 제공
- **컴포넌트 기반 개발**: 재사용 가능한 UI 컴포넌트 설계 및 구현

### 주요 타겟 사용자
- **주 사용자**: 스마트폰 및 차량 주변용품을 원하는 일반 소비자 (20-50대)
